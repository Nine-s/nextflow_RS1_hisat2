...
include { HISAT2_INDEX_REFERENCE ; HISAT2_INDEX_REFERENCE_ExSp ; HISAT2_ALIGN ; EXTRACT_SPLICE_SITES ; EXTRACT_EXONS } from './modules/hisat2.nf'
...
workflow {
    ...
    if (params.mode == "minimum_genome_build") {
        ...
        HISAT2_INDEX_REFERENCE_ExSp( params.reference_genome, EXTRACT_EXONS.out, EXTRACT_SPLICE_SITES.out )
        HISAT2_ALIGN( read_pairs_ch, HISAT2_INDEX_REFERENCE_ExSp.out, CHECK_STRANDNESS.out.first() )
    }
